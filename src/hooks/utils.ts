/**disables bubbling and defaults */
...
/** removes duplicates from Array - fastest solution */
...
export const checkHeldKeysRecursive: any = (
  shortcutKey: any,
  // Tracks the call interation for the recursive function,
  // based on the previous index;
  shortcutArray: Array<any>,
  heldKeysArray: Array<any>,
